...
async def setup():
    ...
    guild.role_birthday      = 851143639803625473  # put in the role IDs for your server here
    ...
    guild.role_member        = 851143225029034027  # put in the role IDs for your server here
    guild.role_memberedition = 851143476132446248  # put in the role IDs for your server here
    guild.role_memberplus    = 851143364900683786  # put in the role IDs for your server here
    guild.role_memberpro     = 851143421569663036  # put in the role IDs for your server here
    guild.role_moderator     = 786239819021287435  # put in the role IDs for your server here
    guild.role_mute          = 851143303646150687  # put in the role IDs for your server here
    ...
    guild.channel_botspam        = 845578875782430720  # put in the channel IDs for your server here
    ...
    guild.channel_private        = 786239530558423144  # put in the channel IDs for your server here
    guild.channel_general        = 733933987244015626  # put in the channel IDs for your server here
